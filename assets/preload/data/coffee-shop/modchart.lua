...
function update (elapsed)
   ...
   if swayingsmall then
    for i=4,7 do
			setActorX(_G['defaultStrum'..i..'X'] + 8 * math.sin((currentBeat + i*0.33) * math.pi), i)
		end
   end
...
function stepHit (step)
    if step == 336 then
        for i = 1, 1 do
			tweenPosXAngle(i, _G['defaultStrum'..i..'X'] + 20,getActorAngle(i), 3.66)
		end
        for i = 2, 2 do
			tweenPosXAngle(i, _G['defaultStrum'..i..'X'] + 40,getActorAngle(i), 3.66)
		end
        for i = 3, 3 do
			tweenPosXAngle(i, _G['defaultStrum'..i..'X'] + 80,getActorAngle(i), 3.66)
		end
    end
    if step == 346 then
        for i = 0, 3 do
			tweenPosYAngle(i, _G['defaultStrum'..i..'Y'] - 50, 0, 0.2)
		end
	end
    if step == 348 then
        for i = 0, 3 do
    ...
    if step == 368 then
        for i = 1, 1 do
			tweenPosXAngle(i, _G['defaultStrum'..i..'X'],getActorAngle(i), 3.66)
		end
        for i = 2, 2 do
			tweenPosXAngle(i, _G['defaultStrum'..i..'X'],getActorAngle(i), 3.66)
		end
    ...
    if step == 400 then
        for i = 4, 4 do
            tweenPosXAngle(i, _G['defaultStrum'..i..'X'] - 51.5625,getActorAngle(i), 3.66)
        end
        for i = 5, 5 do
            tweenPosXAngle(i, _G['defaultStrum'..i..'X'] - 34.375,getActorAngle(i), 3.66)
        end
        for i = 6, 6 do
            tweenPosXAngle(i, _G['defaultStrum'..i..'X'] - 17.1875,getActorAngle(i), 3.66)
        end
    end
    if step == 410 then
        for i = 4, 7 do
    ...
    if step == 456 then
        tweenCameraZoom(1.2, 0.1)
        for i = 0, 3 do 
            tweenFadeOut(i, 0, 0.005)
        end
	end
    if step == 464 then
        noteleftright = true
        for i = 0, 3 do 
            tweenFadeIn(i, 1, 0.005)
        end
    end
    if step == 488 then
        swayingvert = true
    ...
    if step == 1096 then
        swayingsmall = false
        for i = 4, 7 do
			tweenPosXAngle(i, _G['defaultStrum'..i..'X'],getActorAngle(i), 0.1)
		end
	end
end