...
function update (elapsed)
   ...
   if swayingsmall then
    for i=6,7 do
			...
			setActorY(_G['defaultStrum'..i..'Y'] + 8 * math.cos((currentBeat + i*4) * math.pi) ,i)
		end
    for i=0,1 do
        setActorX(_G['defaultStrum'..i..'X'] - 16 * math.sin((currentBeat + i*0)), i)
        setActorY(_G['defaultStrum'..i..'Y'] - 8 * math.cos((currentBeat + i*4) * math.pi) ,i)
...
function stepHit (step)
    if step == 640 then
        for i = 4, 7 do
			tweenPosXAngle(i, _G['defaultStrum'..i..'X'] - 275,getActorAngle(i), 0.1)
		end
        for i = 0, 3 do
            tweenPosXAngle(i, _G['defaultStrum'..i..'X'] - 600,getActorAngle(i), 0.1)
        end
        for i = 0, 3 do 
            tweenFadeOut(i, 0.70, 0.2)
        end
    end
    if step == 669 then
        for i = 0, 3 do
			tweenPosXAngle(i, _G['defaultStrum'..i..'X'] + 320,getActorAngle(i), 0.1)
		end
        for i = 4, 7 do
            tweenPosXAngle(i, _G['defaultStrum'..i..'X'] + 600,getActorAngle(i), 0.1)
        end
    ...
    if step == 769 then
        for i = 4, 7 do
			tweenPosXAngle(i, _G['defaultStrum'..i..'X'] - 275,getActorAngle(i), 3)
		end
        for i = 0, 3 do
			tweenPosXAngle(i, _G['defaultStrum'..i..'X'] + 320,getActorAngle(i), 3)
		end
        for i = 4, 7 do 
            tweenFadeOut(i, 0, 2)
        end
